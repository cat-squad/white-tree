...
Below are some libraries and best-practices I'd recommend looking into when building an app with React.
...
* [material-ui-next](https://material-ui-next.com/)– Components!
...
## Styling with Material-UI-Next + CSS-in-JS
